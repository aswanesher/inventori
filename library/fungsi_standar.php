...
//fungsi tampil created by Hendra McHen
	...
	echo "&nbsp;Dari&nbsp;".$totpage."&nbsp;|&nbsp;";
	if($page!=1){echo "<a href='".$paramsnav."&page=1'><<</a>&nbsp;";}else{echo "F&nbsp;";}
	if($page>1){echo "<a href='".$paramsnav."&page=".($page-1)."'><</a>&nbsp;";}else{echo "P&nbsp;";}
	for($i=$startpagesess;$i<=$endpagesess;$i++){
		if($page==$i){
		echo $i."&nbsp;";
		}else{
		echo "<a href='".$paramsnav."&page=".$i."'>".$i."</a>&nbsp;";
		}
	}
	if($page<$totpage){echo "<a href='".$paramsnav."&page=".($page+1)."'>></a>&nbsp;";}else{echo "N&nbsp;";}
	if($page<$totpage){echo "<a href='".$paramsnav."&page=".$totpage."'>>></a>&nbsp;";}else{echo "L&nbsp;";}
}
?> 