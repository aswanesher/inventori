...
<table cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table cellspacing="1" cellpadding="0">
      ...
      <?php } ?>
      <tr>
        <td style="color:#FFF; background-color:#333; border:none" colspan="4" align="right">total Qty :</td>
      ...
      <tr>
      	<td style="color:#FFF; background-color:#333; border:none" colspan="7" align="right">Total keseluruhan (total + ongkos truk) =</td>
